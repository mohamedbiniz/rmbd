...
import at.ainf.protegeview.gui.buttons.AddToBackgroundButton;
import at.ainf.protegeview.gui.buttons.RemoveFromBackgroundButton;
...
public class BackgroundView extends AbstractQueryViewComponent {
    ...
    protected void updateDisplayedOntologyAxioms() {
        ...
        Set<OWLLogicalAxiom> bgAxioms = searchCreator.getSearch().getTheory().getBackgroundFormulas();
