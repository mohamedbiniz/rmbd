...
public class DebugTabVw extends AbstractOWLViewComponent implements Resettable {
    public static final String ID = "at.ainf.protegeview.DebugTabVw";
    ...
    private void createViewPanes(boolean reset) {
        addPane(QUERY_PANEL,
                "/src/main/resources/debug-tab-query-panel.xml",
                "at.ainf.protegeview.DebugTabVw.query",
                reset,DebugIconsLoader.QUERY);
        cardPanel.setMnemonicAt(0, KeyEvent.VK_Q);


        addPane(DIAGNOSES_PANEL,
                "/src/main/resources/debug-tab-diagnoses-panel.xml",
                "at.ainf.protegeview.DebugTabVw.diagnoses",
        ...
        addPane(OPTIONS_PANEL,
                ...
                "at.ainf.protegeview.DebugTabVw.option",
                reset, DebugIconsLoader.OPTION);
        cardPanel.setMnemonicAt(2, KeyEvent.VK_O);


        addPane(TESTCASES_PANEL,
                "/src/main/resources/debug-tab-testcases-panel.xml",
                "at.ainf.protegeview.DebugTabVw.testcases",
        ...
        addPane(PREVIEW_PANEL,
                ...
                "at.ainf.protegeview.DebugTabVw.preview",
