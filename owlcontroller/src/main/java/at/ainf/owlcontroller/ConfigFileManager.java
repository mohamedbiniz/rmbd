...
public class ConfigFileManager {
    ...
    private static SearchType parseSearchType(String searchType) {
    ...
    private static QSS parseQSS (String qss) {
    ...
    public static SearchConfiguration getDefaultConfig() {
        ...
        conf.aBoxInBG = true;
        conf.tBoxInBG = false;
        conf.searchType = SearchType.UNIFORM_COST;
        conf.treeType = TreeType.REITER;
        conf.numOfLeadingDiags = 9;
        conf.qss = QSS.MINSCORE;
