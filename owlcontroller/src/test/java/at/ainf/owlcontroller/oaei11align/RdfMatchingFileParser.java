...
public class RdfMatchingFileParser extends DefaultHandler {
    ...
    public Map<OWLLogicalAxiom,Double> getMappings() {
        Map<OWLLogicalAxiom,Double> mappingsOwl = new HashMap<OWLLogicalAxiom, Double>();
    ...
    public void endElement(java.lang.String uri, java.lang.String localName, java.lang.String qName) throws SAXException
    {
        if (qName.equals("onto1"))
            ...
            lastMapping.measure = Double.valueOf(lastCharacters);
