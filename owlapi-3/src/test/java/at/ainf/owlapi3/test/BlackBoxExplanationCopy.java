 ...
 */
public class BlackBoxExplanationCopy extends SingleExplanationGeneratorImpl implements SingleExplanationGenerator {

    public static final Logger log = Logger.getLogger(BlackBoxExplanationCopy.class.getName());
    ...
    public BlackBoxExplanationCopy(OWLOntology ontology, OWLReasonerFactory reasonerFactory, OWLReasoner reasoner) {
...
//        }
    ...
    private int numOfSatChecks = 0;

    public int getNumOfSatChecks() {
        return numOfSatChecks;
    }

    public void resetNumOfSatChecks() {
     ...
     */
    public boolean isSatisfiable(OWLClassExpression unsatClass) throws OWLException {
