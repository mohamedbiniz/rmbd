 ...
 */
public class MyOWLFrameListRenderer implements ListCellRenderer {
    ...
    public MyOWLFrameListRenderer(OWLEditorKit owlEditorKit) {
        this.owlEditorKit = owlEditorKit;
        owlCellRenderer = new OWLCellRenderer(owlEditorKit);
        separatorRenderer = new DefaultListCellRenderer();
        OWLAnnotationCellRenderer annotationRenderer = new OWLAnnotationCellRenderer(owlEditorKit);
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected,
        ...
        if (value instanceof OWLFrameSection) {
            ...
            // final TcaeFrameSectionItem row = (TcaeFrameSectionItem) value;
