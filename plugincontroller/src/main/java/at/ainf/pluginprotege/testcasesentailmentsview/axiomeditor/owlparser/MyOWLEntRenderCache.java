 ...
 */
public class MyOWLEntRenderCache implements OWLEntityRenderingCache {
    ...
    public void rebuild() {
        clear();
        OWLModelManagerEntityRenderer entityRenderer = new OWLEntityRendererImpl();
        ...
        // datatypes
        final OWLDataTypeUtils datatypeUtils = new OWLDataTypeUtils(ontology.getOWLOntologyManager());
    ...
    private <T extends OWLEntity> void addRendering(T entity, Map<String, T> map) {
        if (!entityRenderingMap.containsKey(entity)) {
            String rendering = new OWLEntityRendererImpl().render(entity);
