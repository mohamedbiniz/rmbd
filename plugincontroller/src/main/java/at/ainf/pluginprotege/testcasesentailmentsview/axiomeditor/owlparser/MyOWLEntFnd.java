 ...
 */
public class MyOWLEntFnd implements OWLEntityFinder, OWLEntityChecker {
    ...
    public Set<OWLEntity> getEntities(IRI iri) {
        ...
        if (ont.containsClassInSignature(iri)) {
            entities.add(ont.getOWLOntologyManager().getOWLDataFactory().getOWLClass(iri));
        }
        if (ont.containsObjectPropertyInSignature(iri)) {
            entities.add(ont.getOWLOntologyManager().getOWLDataFactory().getOWLObjectProperty(iri));
        }
        if (ont.containsDataPropertyInSignature(iri)) {
            entities.add(ont.getOWLOntologyManager().getOWLDataFactory().getOWLDataProperty(iri));
        }
        if (ont.containsIndividualInSignature(iri)) {
            entities.add(ont.getOWLOntologyManager().getOWLDataFactory().getOWLNamedIndividual(iri));
        }
        if (ont.containsAnnotationPropertyInSignature(iri)) {
            entities.add(ont.getOWLOntologyManager().getOWLDataFactory().getOWLAnnotationProperty(iri));
        }
        if (ont.containsDatatypeInSignature(iri)) {
            entities.add(ont.getOWLOntologyManager().getOWLDataFactory().getOWLDatatype(iri));
        }
    ...
    private <T extends OWLEntity> Set<T> getAllEntities(Class<T> type) {
        if (type.equals(OWLDatatype.class)) {
            ...
            TreeSet.add(ont);
            return (Set<T>) new OWLDataTypeUtils(ont.getOWLOntologyManager()).getKnownDatatypes(TreeSet);
        } else {
