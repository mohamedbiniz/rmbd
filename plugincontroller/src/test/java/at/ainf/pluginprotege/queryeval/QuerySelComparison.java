...
import at.ainf.pluginprotege.distributiongenerators.ExtremeDistribution;
import at.ainf.pluginprotege.distributiongenerators.ModerateDistribution;
import at.ainf.pluginprotege.queryeval.result.TableList;
import at.ainf.pluginprotege.queryeval.result.Time;
import at.ainf.pluginprotege.queryeval.result.UserProbAndQualityTable;
...
public class QuerySelComparison {
    ...
    private final String[] ontologies = {"CHEM-A.owl", "koala.owl", "buggy-sweet-jpl.owl", "miniTambis.owl", "Univ.owl",
    ...
    public static void setUp() {
        String conf = ClassLoader.getSystemResource("plugincontroller-log4j.properties").getFile();
    ...
    private OWLTheory createOWLTheory(OWLOntology ontology) {
        ...
        try {
            ...
            result = new OWLTheory(reasonerFactory, ontology, bax,true);
    ...
    public void testKoala() throws NoConflictException, SolverException, UnsatisfiableFormulasException {
        ...
        String ontologyFileString = "koala.owl";
        rnd.setSeed(1000);
  ...
  private boolean generateQueryAnswer
    ...
    */
    ...
    private Set<HittingSet<OWLLogicalAxiom>> chooseUserProbab
        ...
        ArrayList<ManchesterOWLSyntax> keywordList = new ArrayList<ManchesterOWLSyntax>(EnumSet.copyOf(m.
                getProbMap().keySet()));
